...
export const mockCategories: Category[] = [
  {
    id: '1',
    name: 'Crypto',
    description: 'Memes about cryptocurrency, blockchain, and Web3',
    icon: 'bitcoin',
    activeBattles: 1,
    prizePool: 1.5,
  ...
  },
  {
    id: '3',
    name: 'Tech',
    description: 'Memes about technology and gadgets',
    icon: 'cpu',
    activeBattles: 1,
    prizePool: 1.2,
  ...
  },
  {
    id: '4',
    name: 'Funny',
    description: 'General funny memes that will make you laugh',
    icon: 'laugh',
    activeBattles: 1,
    prizePool: 2.0,
  ...
  },
  {
    id: '5',
    name: 'NFT',
    description: 'Memes about NFTs and digital collectibles',
    icon: 'image',
    activeBattles: 1,
    prizePool: 1.75,
...
export const mockBattles: Battle[] = [
  ...
  },
  {
    ...
    endDate: new Date(Date.now() + 60 * 3600 * 1000).toISOString(),
    memes: [mockMemes[3], mockMemes[7]],
    status: 'ongoing',
    prizePool: 1.2,
  },
  {
